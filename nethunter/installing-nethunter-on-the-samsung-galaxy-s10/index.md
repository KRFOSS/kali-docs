...
만약 최신 업데이트를 설치한 상태에서 깨끗하게 플래시 하는 것을 원치 않는다면 다음 단계로 건너뛰세요: [sammobile.com/samsung/galaxy-s10/firmware/SM-G973F/`](https://www.sammobile.com/samsung/galaxy-s10/firmware/SM-G973F/)
...
순정 롬을 플래시하세요, 예를 들어 리눅스에서는 odin4를 사용할 수 있어요: [github.com/Adrilaw/OdinV4](https://github.com/Adrilaw/OdinV4)
...
kalilibnexmon.so: [다운로드](https://gitlab.com/kalilinux/nethunter/build-scripts/kali-nethunter-kernels/-/raw/main/ten/angler-los/system/lib64/kalilibnexmon.so)

chroot 환경에 `/lib/kalilibnexmon.so`로 복사하세요.
