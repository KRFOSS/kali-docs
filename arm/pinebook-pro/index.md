...
```console
$ xzcat kali-linux-2023.4-pinebook-pro-arm64.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2023.4-pinebook-pro-arm64.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
