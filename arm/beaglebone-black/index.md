...
```console
$ xzcat kali-linux-2024.4-beaglebone-black-armhf.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
...
```console
$ xzcat images/kali-linux-2024.4-beaglebone-black-armhf.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
