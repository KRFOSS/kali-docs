...
```console
$ xzcat kali-linux-2023.1-beaglebone-black-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat images/kali-linux-2023.1-beaglebone-black-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
