...
```console
$ xzcat kali-linux-2021.1-odroidc2.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2021.1-odroidc2.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
