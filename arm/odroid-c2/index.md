...
```console
$ xzcat kali-linux-2022.4-odroid-c2-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2022.4-odroid-c2-arm64.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
