...
2. Download _and validate_ the `Kali Raspberry Pi Zero 2 W` image from the [downloads](https://www.offensive-security.com/kali-linux-arm-images/) area. The process for validating an image is described in more detail on [Downloading Kali Linux](/docs/introduction/download-official-kali-linux-images/).
...
```console
$ xzcat kali-linux-2021.4-rpi-zero-2-w-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
