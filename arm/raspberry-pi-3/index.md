...
[라즈베리 파이 3](https://www.raspberrypi.org/products/raspberry-pi-3-model-b/)은 쿼드 코어 1.2GHz 프로세서와 1GB RAM을 갖추고 있어요. 칼리 리눅스는 외장 마이크로 SD 카드에 설치해 사용할 수 있어요.
...
3. **[dd](https://manpages.debian.org/buster/coreutils/dd.1.en.html)** 유틸리티를 사용하여 이 파일을 마이크로 SD 카드에 이미징하세요([Kali USB 만들기](/docs/usb/live-usb-install-with-windows/)와 동일한 과정).
...
_dd_ 작업이 완료되면 마이크로 SD를 꽂은 상태로 라즈베리 파이 3을 부팅하세요.
