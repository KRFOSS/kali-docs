...
```console
$ xzcat kali-linux-2022.3-raspberry-pi-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```

**or**

```console
$ xzcat kali-linux-2022.3-raspberry-pi-xfce-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
