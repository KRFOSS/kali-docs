...
```console
$ xzcat kali-linux-2023.2-raspberry-pi-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```

**or**

```console
$ xzcat kali-linux-2023.2-raspberry-pi-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
