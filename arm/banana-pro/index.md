...
```console
$ xzcat kali-linux-2022.1-banana-pro-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat images/kali-linux-2022.1-banana-pro-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
