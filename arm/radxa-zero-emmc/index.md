...
```console
$ xzcat kali-linux-2024.4-radxa-zero-emmc-arm64.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2024.4-radxa-zero-emmc-arm64.img.xz | sudo dd of=/dev/mmcblk0 bs=4M status=progress
```
