...
```console
$ xzcat kali-linux-2022.3-radxa-zero-emmc-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
...
```console
$ xzcat kali-linux-2022.3-radxa-zero-emmc-arm64.img.xz | sudo dd of=/dev/mmcblk0 bs=4M status=progres
```
