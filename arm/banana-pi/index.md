...
```console
$ xzcat kali-linux-2022.3-banana-pi-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat images/kali-linux-2022.3-banana-pi-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
