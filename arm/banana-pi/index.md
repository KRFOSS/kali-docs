...
```console
$ xzcat kali-linux-2024.3-banana-pi-armhf.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
...
```console
$ xzcat images/kali-linux-2024.3-banana-pi-armhf.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
