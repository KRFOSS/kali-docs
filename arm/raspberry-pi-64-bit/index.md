...
```console
$ xzcat kali-linux-2023.3-raspberry-pi-armhf-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```

**or**

```console
$ xzcat kali-linux-2023.3-raspberry-pi-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
