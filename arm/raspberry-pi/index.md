...
2. Download _and validate_ the Kali Linux Raspberry Pi 1 image from the [downloads](https://www.offensive-security.com/kali-linux-arm-images/) area. The process for validating an image is described in more detail on [Downloading Kali Linux](/docs/introduction/download-official-kali-linux-images/).
...
```console
$ xzcat kali-linux-2022.2-raspberry-pi1-xfce-armel.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
