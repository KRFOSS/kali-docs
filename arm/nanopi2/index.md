...
[나노파이2](http://nanopi.io/nanopi2.html)는 쿼드 코어 1.9GHz 프로세서와 1GB RAM을 탑재하고 있습니다. 칼리 리눅스는 외장 마이크로 SD 카드에 설치할 수 있습니다.
...
_dd_ 작업이 완료되면, 마이크로 SD 카드를 꽂은 상태로 나노파이2를 부팅하세요.
