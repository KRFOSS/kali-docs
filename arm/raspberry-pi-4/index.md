...
[라즈베리 파이 4](https://www.raspberrypi.org/products/raspberry-pi-4-model-b/)는 쿼드 코어 1.5GHz 프로세서를 탑재하고 있으며, 모델에 따라 2GB, 4GB 또는 8GB RAM을 갖추고 있어요. 칼리 리눅스는 마이크로 SD 카드에서 실행돼요.
...
_dd_ 작업이 완료되면 마이크로 SD를 꽂은 상태로 라즈베리 파이 4를 부팅하세요.
