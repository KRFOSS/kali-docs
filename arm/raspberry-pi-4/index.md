...
```console
$ xzcat kali-linux-2023.3-raspberry-pi-armhf.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```

**or**

```console
$ xzcat kali-linux-2023.3-raspberry-pi-arm64.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
