...
1. 최소 8GB 용량의 빠른 마이크로 SD 카드를 준비하세요. Class 10 카드를 적극 권장합니다.
...
3. **[dd](https://manpages.debian.org/testing/coreutils/dd.1.en.html)** 유틸리티를 사용하여 이 파일을 마이크로 SD 카드에 쓰세요([칼리 USB 만들기](/docs/usb/live-usb-install-with-windows/)와 동일한 과정).
...
9. 마이크로 SD 카드를 SS808에 삽입하고 부팅하세요.
...
_dd_ 작업이 완료되면 마이크로 SD 카드를 삽입한 상태로 SS808을 부팅하세요.
