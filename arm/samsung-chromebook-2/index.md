...
By default, the Kali Linux Samsung Chromebook 2 image contains the [**kali-linux-default** metapackage](/docs/general-use/metapackages/) similar to most other platforms. If you wish to install extra tools please refer to our [metapackages page](/docs/general-use/metapackages/).
...
```console
$ xzcat kali-linux-2021.3-exynos.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
