...
```console
$ xzcat kali-linux-2023.3-nanopi-neo-plus2-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat images/kali-linux-2023.3-nanopi-neo-plus2-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
