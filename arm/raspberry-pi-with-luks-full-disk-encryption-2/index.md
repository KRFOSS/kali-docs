...
```console
$ wget https://kali.download/arm-images/kali-2023.3/kali-linux-2023.3-raspberry-pi-arm64.img.xz
$ xzcat kali-linux-2023.3-raspberry-pi-arm64.img.xz | sudo dd of=/dev/sdX bs=512k status=progress
```
...
# LINUX IMAGE FILE ------------------------------------------------------------
export _IMAGEURL=https://images.kali.org/arm-images/kali-linux-2023.3-raspberry-pi-arm64.img.xz
