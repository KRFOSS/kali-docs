...
weight:
author: ["steev",]
build-script: https://gitlab.com/kalilinux/build-scripts/kali-arm/-/blob/master/usbarmory-mki.sh
...
```console
$ xzcat kali-linux-2021.4-usbarmory-mki-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
