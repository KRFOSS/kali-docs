...
[RIoTboard](http://riotboard.org/)는 1GB RAM을 갖춘 Cortex A9 1GHz 프로세서를 탑재하고 있습니다. 칼리 리눅스는 외장 마이크로 SD 카드에 설치됩니다.
...
_dd_ 작업이 완료되면 마이크로 SD 카드를 삽입한 상태로 RIoTboard를 부팅하세요.
