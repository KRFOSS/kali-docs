...
[락사 제로](https://wiki.radxa.com/Zero)는 쿼드 코어 1.8GHz 프로세서와 512MB, 1GB, 2GB, 또는 4GB의 LPDDR4 RAM을 갖추고 있습니다. 칼리 리눅스는 외장 microSD 카드에 설치할 수 있습니다.
...
_dd_ 작업이 완료되면, microSD 카드를 꽂은 상태로 락사 제로를 부팅하세요.
