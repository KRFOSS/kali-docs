...
```console
$ xzcat kali-linux-2023.1-radxa-zero-sdcard-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2023.1-radxa-zero-sdcard-arm64.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
