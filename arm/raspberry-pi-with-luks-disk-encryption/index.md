...
```
dd if=/root/kali-2019.4-rpi3-nexmon.img of=/dev/sdb bs=4M
```
...
{{% notice info %}}
Do NOT add the "...SNIP..." they are a placeholder to mean there is more stuff there, that we aren't editing.
{{% /notice %}}
