...
```console
$ xzcat kali-linux-2022.3-odroid-xu3-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2022.3-odroid-xu3-armhf.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
...
```console
$ xzcat images/kali-linux-2022.3-odroid-xu3-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
