...
```console
$ xzcat kali-linux-2021.3-odroidxu3.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2021.3-odroidxu3.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
