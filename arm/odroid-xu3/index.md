...
```console
$ xzcat kali-linux-2022.1-odroid-xu3-xfce-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2022.1-odroid-xu3-xfce-armhf.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
