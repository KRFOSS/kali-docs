...
-   [칼리 네트워크 저장소](/docs/general-use/kali-apt-sources/) 및 [Kali 브랜치](/docs/general-use/kali-branches/)는 보다 안정적인 설치를 원하는 사용자가 참고하면 유용합니다.
...
-   [도커 이미지 사용 방법](/docs/containers/using-kali-docker-images/) 및 systemd 기능 관련 정보입니다.
