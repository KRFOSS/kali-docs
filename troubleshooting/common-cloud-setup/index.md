...
-   [칼리 네트워크 저장소](/docs/general-use/kali-apt-sources/) 및 [칼리 브랜치](/docs/general-use/kali-branches/)는 보다 안정적인 설치를 원하는 사용자가 참고하면 유용합니다.
...
-   [엔비디아 카드 활성화 방법](/docs/general-use/install-nvidia-drivers-on-kali-linux/)
