...
```console
kali@kali:~$ wget https://kali.download/base-images/kali-2026.2/kali-linux-2026.2-installer-amd64.iso
...
[커뮤니티 미러 목록](/docs/community/kali-linux-mirrors/)에서 원하는 미러의 링크를 복사한 뒤, URL 중 **README** 부분을 `kali-2026.2/kali-linux-2026.2-installer-amd64.iso`(또는 사용 중인 ISO 경로)로 변경하여 사용하면 됩니다. 앞서 `curl` 예제에서 `kali-images/` 뒤에 나오는 부분을 참고하세요.
