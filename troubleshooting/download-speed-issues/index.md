...
```console
kali@kali:~$ curl -i https://cdimage.kali.org/kali-2025.4/kali-linux-2026.2-installer-amd64.iso
HTTP/1.1 302 Found
Server: nginx
...
Link: <https://kali.download/base-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso>; rel=duplicate; pri=1; geo=ae
Link: <https://ask4.mm.fcix.net/kali-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso>; rel=duplicate; pri=2; geo=gb
Link: <https://ftp.hands.com/kali-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso>; rel=duplicate; pri=3; geo=gb
Location: https://mirror.vinehost.net/kali-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso
...
```console
kali@kali:~$ wget https://kali.download/base-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso
--2025-06-18 10:53:17--  https://kali.download/base-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso
...
Cache-Control: private, no-cache
Link: <https://kali.download/base-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso>; rel=duplicate; pri=1; geo=ae
Location: https://archive-4.kali.org/kali-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso

kali@kali:~$ wget https://archive-4.kali.org/kali-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso
--2025-06-18 10:56:00--  https://archive-4.kali.org/kali-images/kali-2025.4/kali-linux-2026.2-installer-amd64.iso
...
[커뮤니티 미러 목록](/docs/community/kali-linux-mirrors/)에서 원하는 미러의 링크를 복사한 뒤, URL 중 **README** 부분을 `kali-2025.4/kali-linux-2026.2-installer-amd64.iso`(또는 사용 중인 ISO 경로)로 변경하여 사용하면 됩니다. 앞서 `curl` 예제에서 `kali-images/` 뒤에 나오는 부분을 참고하세요.
