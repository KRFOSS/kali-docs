...
메사 3D는 칼리 리눅스를 구동하는 그래픽 스택의 기본 부분입니다. 메사3D의 버전은 21이며, 2021년 3월에 출시되었습니다, WSL에서 GPU 가속된 3D 그래픽을 지원합니다. 이 기능은 하드웨어에서 다이렉트3D 12를 지원하는 경우 사용할 수 있습니다. 그리고 대략적으로, WSL을 통해 윈도우에서 칼리 리눅스를 실행하는 경우 GPU를 사용하는 GUI 앱은 훨씬 더 나은 성능을 발휘합니다.
...
APT가 칼리 실험적 저장소를 인식할 수 있도록 다시 업데이트하세요:
