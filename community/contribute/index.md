...
Following us on social media and engaging with our content is a very easy way to help out! At the bottom of this page in the footer you can find all of our links to various platforms and social media. We currently are on [Facebook](https://www.facebook.com/kalilinux), [Instagram](https://www.instagram.com/kalilinux/), [Mastodon](https://infosec.exchange/@kalilinux), and [Twitter](https://twitter.com/kalilinux).

Something else that is helpful is leaving reviews or ratings on some of the platforms that we are on that you may use. These include [Azure](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/kali-linux.kali?tab=Reviews), [AWS](https://aws.amazon.com/marketplace/pp/prodview-fznsw3f7mq7to), [WSL](https://apps.microsoft.com/store/detail/kali-linux/9PKR34TNCV07?hl=en-us&gl=us), and [Docker](https://hub.docker.com/r/kalilinux/kali-rolling). Please only do so if you use the platform that you are reviewing. These reviews help us and other users, so it is a good way to help out the community!
