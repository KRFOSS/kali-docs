...
```console
kali@kali:~$ dd if=kali-linux-2023.1-live-amd64.iso of=/dev/sdb conv=fsync bs=4M
```
...
```console
kali@kali:~$ dd if=kali-linux-2023.1-live-amd64.iso of=/dev/sdb conv=fsync bs=4M status=progress
```
...
```console
kali@kali:~$ dd if=kali-linux-2023.1-live-amd64.iso | pv -s 2.8G | dd of=/dev/sdb conv=fsync bs=4M
```
