...
```console
kali@kali:~$ dd if=kali-linux-2024.4-live-amd64.iso of=/dev/sdX conv=fsync bs=4M status=progress
```
...
```console
kali@kali:~$ dd if=kali-linux-2024.4-live-amd64.iso | pv -s 2.8G | dd of=/dev/sdX conv=fsync bs=4M
```
