...
$ wget https://http.kali.org/kali/pool/main/l/live-build/live-build_2023.331+kali4_all.deb
```
...
$ sudo dpkg -i live-build_2023.331+kali4_all.deb
```
...
[...]
***
GENERATED KALI IMAGE: ./images/kali-2023.3/kali-linux-2023.3-installer-amd64.iso
***
kali@kali:~$
```
