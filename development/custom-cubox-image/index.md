...
이 문서는 **커스텀 Kali Linux CuBox ARM 이미지**를 만드는 우리만의 방법을 설명하며 개발자를 대상으로 해요. 미리 만들어진 Kali 이미지를 설치하고 싶다면, [CuBox에 Kali 설치하기](/docs/arm/cubox/) 문서를 참고하세요.
...
dd 작업이 완료되면, SD 카드를 마운트 해제하고 꺼낸 다음 CuBox를 Kali Linux로 부팅하세요
