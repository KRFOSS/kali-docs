...
이 문서는 **커스텀 칼리 리눅스 Beaglebone Black ARM 이미지**를 만드는 우리만의 방법을 설명하며 개발자를 대상으로 해요. 미리 만들어진 칼리 이미지를 설치하고 싶다면, [Beaglebone Black에 칼리 설치하기](/docs/arm/beaglebone-black/) 문서를 참고하세요.
